...
class HalfEdge {
    ...
    /**
     * Constructs a quickHull.HalfEdge with head vertex <code>v</code> and
...
// 	 */
// 	public double turnProduct (quickHull.HalfEdge he1, quickHull.Vector3d nrml)
// 	 {
// 	   quickHull.Point3d pnt0 = tail().pnt;
// 	   quickHull.Point3d pnt1 = head().pnt;
// 	   quickHull.Point3d pnt2 = he1.head().pnt;
