 ...
 * href=quickHull.HalfEdge>HalfEdges</a> which surround the face in a
...
class Face {
    ...
    /**
     * Constructs a triangule quickHull.Face from vertices v0, v1, and v2.
     *
     * @param v0 first vertex
     * @param v1 second vertex
     * @param v2 third vertex
     */
    private static Face createTriangle(Vertex v0, Vertex v1, Vertex v2,
            double minArea) {
        Face face = new Face();
    ...
    public static Face create(Vertex[] vtxArray, int[] indices) {
        ...
        for (int index1 : indices) {
            HalfEdge he = new HalfEdge(vtxArray[index1], face);
            if (hePrev != null) {
                he.setPrev(hePrev);
                hePrev.setNext(he);
            } else {
    ...
    private void computeCentroid(Point3d centroid) {
        centroid.setZero();
        HalfEdge he = he0;
        do {
    ...
    private void computeNormal(Vector3d normal, double minArea) {
